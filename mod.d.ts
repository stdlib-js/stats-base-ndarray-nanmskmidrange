...
/**
* Calculates the mid-range of a one-dimensional ndarray according to a mask, ignoring `NaN` values.
*
...
* // returns 0.0
*/
declare function nanmskmidrange<T extends typedndarray<number> = typedndarray<number>>( arrays: [ T, T ] ): number;
